...
```{r generate alpha sublists 1, echo=T,  eval=F, cache=T,}
...
```{r alpha diversity check 1, echo=T,  eval=F, cache=T, fig.width=9, fig.height=17, message=FALSE, warning=FALSE}
...
```{r Bray Curtis ITS, echo=T,  eval=T, fig.width=8, fig.height=8}
...
```{r Bray Curtis 16S, echo=T,  eval=T, fig.width=8, fig.height=8}
...
# Same for X_otu97.5
XITS$X_otu97.5_bkp <- XITS$X_otu97.5
XITS$X_otu97.5 <- FUNS$collapse_duplicates(XITS$X_otu97.5)
X16S$X_otu97.5_bkp <- X16S$X_otu97.5
...
```{r alpha diversity richness, echo=T,  eval=F, cache=T,fig.width=9}
...
```{r alpha diversity richness plots, echo=T,  eval=T, cache=T,fig.width=9}
...
```{r alpha diversity diversity, echo=T,  eval=F, cache=T,fig.width=9}
...
```{r alpha diversity diversity plots, echo=T,  eval=T, cache=T,fig.width=9}
...
```{r alpha diversity evenness, echo=T,  eval=F, cache=T,fig.width=9}
...
```{r alpha diversity evenness plots, echo=T,  eval=T, cache=T,fig.width=9}
...
```{r alpha diversity dominance, echo=T,  eval=F, cache=T,fig.width=9}
...
```{r alpha diversity dominance plots, echo=T,  eval=T, cache=T,fig.width=9}
...
```{r alpha diversity rarity, echo=T,  eval=F, cache=T,fig.width=9}
...
```{r alpha diversity rarity plots, echo=T,  eval=T, cache=T,fig.width=9}
...
XITS$taxa <- assignTaxonomy(colnames(XITS$X), "sh_general_release_dynamic_s_all_04.04.2024.fasta",verbose=T,multithread=20)
X16S$taxa <- assignTaxonomy(colnames(X16S$X), "silva_nr99_v138.1_wSpecies_train_set.fa.gz",verbose=T,multithread=20)

```

Next, we define a function to barplot taxonomic data for all, or for a subset of samples:


```{r Taxonomy barplot function, echo = T, eval = F}
...
FUNS$barplot_function(XITS$X,XITS$taxa,"Class",samples=c(1:44),other=12)

FUNS$barplot_function(X16S$X,X16S$taxa,"Class",samples=c(1:51),other=12)
